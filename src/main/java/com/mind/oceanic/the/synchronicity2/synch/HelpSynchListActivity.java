...
public class HelpSynchListActivity extends Activity {
    ...
    Intent intent5 = new Intent(HelpSynchListActivity.this, EventListActivity.class);
...
//                break;
            ...
            case R.id.menu_maintain_synchronicity:
                Intent intent4 = new Intent(HelpSynchListActivity.this, SynchListActivity.class);
            ...
            case R.id.menu_match_events:
                Intent intent6 = new Intent(HelpSynchListActivity.this, MatchKeywordsActivity.class);
                startActivityForResult(intent6, 6);
                break;

            case R.id.menu_import:
                Intent intent7 = new Intent(HelpSynchListActivity.this, DownloadJSON.class);
